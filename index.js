...
global.bot.on('new_chat_members', msg => global.ControlFunctionBotInstance.joinBot(msg))
...
setInterval(global.ControlFunctionBotInstance.sendNews, 1/2*60*60*1000);
//Clear published news in array
setInterval(clearPublishedNews, 4*60*60*1000);
